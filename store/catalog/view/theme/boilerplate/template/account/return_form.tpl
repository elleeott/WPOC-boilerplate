...
<div id="content"><?php echo $content_top; ?>
  ...
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="return">
      ...
      <div id="return-product-row<?php echo $return_product_row; ?>">
        <div class="content">
          ...
          <div class="return-detail">
            ...
            <div class="return-remove"><a onclick="$('#return-product-row<?php echo $return_product_row; ?>').remove();" class="button button-primary"><?php echo $button_remove; ?></a></div>
          </div>
        </div>
      </div>
    ...
    <div class="buttons">
      <div class="right"><a onclick="addReturnProduct();" class="button button-primary"><span><?php echo $button_add_product; ?></span></a></div>
    </div>
    ...
    <div class="buttons">
      ...
      <div class="right"><a onclick="$('#return').submit();" class="button button-primary"><span><?php echo $button_continue; ?></span></a></div>
    </div>
  </form>
...
function addReturnProduct() {
	...
	html += '    </div>';
    html += '    <div class="return-remove"><a onclick="$(\'#return-product-row' + return_product_row + '\').remove();" class="button button-primary"><?php echo $button_remove; ?></a></div>';
	html += '  </div>';
	html += '</div>';
